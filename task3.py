...
base_string = 'Python — высокоуровневый язык программирования общего назначения с динамической строгой типизацией\
    ...
    написанных на нём программ по сравнению с аналогичным кодом, написанным на компилируемых языках'
table = str.maketrans('','', string.punctuation)
res_word = base_string.translate(table)
word = res_word.lower().split()
word_all = len(word)
count = Counter(word)
res = count.most_common(10)
print(f'Всего слов: {word_all}\nЧаще всего встречаются:')
pp(res)
